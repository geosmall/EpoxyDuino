...
void blackbox_log( void )
{
  ...
  *(int16_t *)( &bb_buffer[ pos ] ) = 0; pos += 2;
  *(int16_t *)( &bb_buffer[ pos ] ) = 0; pos += 2;
  *(uint16_t *)( &bb_buffer[ pos ] ) = 0; pos += 2;
  // setpoint
  *(int16_t *)( &bb_buffer[ pos ] ) = 0; pos += 2;
  *(int16_t *)( &bb_buffer[ pos ] ) = 0; pos += 2;
  *(int16_t *)( &bb_buffer[ pos ] ) = 0; pos += 2;
  ...
  *(int16_t *)( &bb_buffer[ pos ] ) = 0; pos += 2;
  // motor
  *(uint16_t *)( &bb_buffer[ pos ] ) = 0; pos += 2; // BR
  *(uint16_t *)( &bb_buffer[ pos ] ) = 0; pos += 2; // FR
  *(uint16_t *)( &bb_buffer[ pos ] ) = 0; pos += 2; // BL
  *(uint16_t *)( &bb_buffer[ pos ] ) = 0; pos += 2; // FL
  // pos is 85
